...
class MDTabbarController: UITabBarController {
    ...
    private func setupChildViewControllers() {
        ...
        // 2. 第三方 (ThirdParty) -> 使用 "cube.transparent" 系列
        // 隐喻：第三方组件、插件、集成
        let thirdPartyVC = UsageThirdPartyViewController()
        setupChild(thirdPartyVC, 
                  title: "第三方", 
                  imageName: "cube.transparent", 
                  selectedImageName: "cube.transparent.fill")
        
        // 3. 基础 (Basic) -> 使用 "text.book.closed" 系列
        // 隐喻：知识库、文档、学习资料
        ...
        // 4. 设计 (Design) -> 使用 "swatchpalette" 系列
        // 隐喻：调色盘、设计系统、创意工具
        ...
        self.viewControllers = [
            ...
            BaseNavigationController(rootViewController: thirdPartyVC),
            BaseNavigationController(rootViewController: basicVC),
            BaseNavigationController(rootViewController: designVC)
        ]
    }
